            ...
            for i, line in enumerate(lines, 1):
                ...
                if f.endswith(".py"):
                    ...
                    if m:
                        ...
                        graph.edges.append(
                            GraphEdge(source=file_id, target=func_id, type="defines")
                        )
                        continue
                    ...
                    if m:
                        ...
                        graph.edges.append(
                            GraphEdge(source=file_id, target=class_id, type="defines")
                        )
            ...
            for i, line in enumerate(lines, 1):
                for match in re.finditer(r"\b(\w+)\s*\(", line):
                    ...
                    if (
                        ...
                        and defined_functions[func_name] != caller_id
                    ):
                        graph.edges.append(
                            GraphEdge(
                                source=caller_id,
                                target=defined_functions[func_name],
                                type="calls",
                            )
                        )
