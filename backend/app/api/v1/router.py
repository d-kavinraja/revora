...
api_router.include_router(
    review_stream.router, prefix="/reviews", tags=["review-stream"]
)
api_router.include_router(
    review_lifecycle.router, prefix="/reviews", tags=["review-lifecycle"]
)
api_router.include_router(reviews.router, prefix="/reviews", tags=["reviews"])
api_router.include_router(dashboard.router, prefix="/dashboard", tags=["dashboard"])
api_router.include_router(api_keys.router, prefix="/api-keys", tags=["api-keys"])
api_router.include_router(
    ui_settings.router, prefix="/ui/settings", tags=["ui-settings"]
)
...
api_router.include_router(
    analytics.router, prefix="/platform-analytics", tags=["analytics"]
)
