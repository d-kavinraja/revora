...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["owner_id"], ["users.id"], name=op.f("fk_organizations_owner_id_users")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_org_members_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_org_members_user_id"), "org_members", ["user_id"], unique=False
    )
