...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_installations_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_installations")),
    )
    op.create_index(
        op.f("ix_installations_installation_id"),
        "installations",
        ["installation_id"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "reviews_enabled", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column(
            "settings",
        ...
        sa.ForeignKeyConstraint(
            ["installation_id"],
            ["installations.id"],
            name=op.f("fk_repositories_installation_id_installations"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["org_id"],
            ["organizations.id"],
            name=op.f("fk_repositories_org_id_organizations"),
            ondelete="SET NULL",
        ),
    ...
    op.create_index(
        op.f("ix_repositories_org_id"), "repositories", ["org_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "repo_id", "pr_number", name=op.f("uq_pull_requests_repo_id_pr_number")
        ),
    )
    op.create_index(
