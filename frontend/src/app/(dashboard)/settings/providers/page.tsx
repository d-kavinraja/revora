    ...
    <div className="w-full max-w-[1200px] mx-auto p-4 md:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {providers.map((provider) => {
          ...
          const isTesting = provider.slug !== 'gemini' && provider.slug !== 'nvidia' && provider.slug !== 'nvidia_nim' && provider.slug !== 'openrouter' && provider.slug !== 'ollama_cloud' && provider.slug !== 'cohere';
          return (
            <div
              key={provider.slug}
