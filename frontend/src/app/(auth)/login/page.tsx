    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      >
        ...
        <Button
          ...
          className="w-full h-12 bg-[#24292e] text-white hover:bg-[#2c3238] border border-white/10 rounded-lg flex items-center justify-center gap-2.5 font-semibold text-sm cursor-pointer shadow-lg transition-all duration-150"
        >
