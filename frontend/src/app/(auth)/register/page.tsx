  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-md p-8 bg-surface-1/80 backdrop-blur-xl border border-border rounded-2xl shadow-2xl z-10"
      >
        ...
        <div className="p-6 rounded-xl border border-warning/25 bg-warning/5 text-center shadow-lg mb-6">
